...
def main(args):
    while True:
        conn = redis.Redis(host=args.redis_host, port=args.redis_port, decode_responses=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--ue_path', type=str, default=os.environ.get("CARLA_SERVER", "~/software/CARLA_0.9.13/CarlaUE4.sh"))
